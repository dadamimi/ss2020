...
install_dependencies(){
    if check_sys packageManager yum; then
        ...
        yum_depends=(
            unzip gzip openssl openssl-devel gcc python38 python38-devel python38-setuptools pcre pcre-devel libtool libevent
        ...
        apt_depends=(
            gettext build-essential unzip gzip python38 python38-dev python38-setuptools curl openssl libssl-dev
